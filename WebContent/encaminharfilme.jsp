...
String dataLocacao = Locacao.getDataLocacao();

%>

<span class="label label-info">Data Locação / Solicitação: </span><br><input type="text" name="txtDataLoc" id="txtDataLoc" value="<%=dataLocacao%>">
<br><br>
<input class="btn btn-success" type="submit" value="Encaminhar Locação" name="btnEncaminhar">
